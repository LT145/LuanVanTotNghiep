// src/types/admin/product_edit.ts

export interface EditableVariantSize {
  id: string
  size: string
  price: number
  stock: number
...
export interface EditableVariantColor {
  id: string
  color: string
  sizes: EditableVariantSize[]
  images: VariantImage[]
}
...
export interface EditableProduct {
  ...
  variantColors: EditableVariantColor[]
  costPrice:number
}
